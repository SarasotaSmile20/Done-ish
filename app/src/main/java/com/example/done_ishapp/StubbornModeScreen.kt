...
fun StubbornModeScreen(navController: NavController) {
    Surface(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Text("Stubborn Mode", fontSize = 26.sp)
            Text("This screen will support locking into a task with intention.", fontSize = 16.sp)
        }
    }
}
...
fun StubbornModePreview() {
    DoneishAppTheme {
        StubbornModeScreen(rememberNavController())
    }
}
