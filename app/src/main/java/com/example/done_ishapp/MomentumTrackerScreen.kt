...
fun MomentumTrackerScreen(navController: NavController) {
    Surface(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            Text("Momentum Tracker", fontSize = 26.sp)
            Text("This screen will help track small wins and micro steps.", fontSize = 16.sp)
        }
    }
}
...
fun MomentumTrackerPreview() {
    DoneishAppTheme {
        MomentumTrackerScreen(rememberNavController())
    }
}
